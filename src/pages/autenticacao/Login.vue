    ...
    <div class="full-height row justify-center">
      <div class="column justify-center" style="width:300px">
        <div style="text-align:left">
          <!-- <q-field icon="account_circle" :error="$v.form.login.$error" error-label="Oops, we got an error.">
            <q-input v-model="form.login" :float-label="$t('Please input login')" />
          </q-field> -->
          <q-input dark type="text" v-model="form.login" :float-label="$t('login')" clearable :error="$t($v.form.login.$error)" :before="[{icon: 'account_circle'}]" autocomplete="new-password" />
